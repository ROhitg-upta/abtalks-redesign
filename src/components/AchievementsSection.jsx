...
export default function AchievementsSection({ studentOverride }) {
  ...
  const hasNoBadges = student.badges.length === 0;
      ...
      >
        ...
        {hasNoBadges ? (
          <div style={{
            ...
            <p style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--muted)", marginBottom: "4px" }}>
              No badges yet
            </p>
            <p style={{ fontSize: "0.78rem", color: "var(--subtle)" }}>
              Complete Day 1 to earn your first star rating.
            </p>
          </div>
        ) : (
          <>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "18px" }}>
          ...
          <div style={{
            ...
            {student.rank ? `#${student.rank} of ${student.totalStudents.toLocaleString()}` : "Unranked"}
          </div>
        </div>

        {student.rank === null && (
          <p style={{ fontSize: "0.8rem", color: "var(--subtle)", marginBottom: "14px" }}>
            You'll appear on the leaderboard once you complete your first day. Here's who's currently leading:
          </p>
        )}
          ...
          {leaderboard.slice(0, 3).map((entry, i) => (
            <motion.div
              ...
              style={{
                ...
                borderRadius: "14px",
                background: entry.isCurrentUser && !studentOverride ? "var(--accent-light)" : "var(--bg-secondary)",
                border: entry.isCurrentUser && !studentOverride ? "1.5px solid var(--accent-muted)" : "1px solid var(--bg-tertiary)",
                gap: "6px",
                position: "relative",
              }}
            >
          ...
          {leaderboard.slice(3).map((entry, i) => (
            <motion.div
              ...
              style={{
                ...
                background: entry.isCurrentUser && !studentOverride ? "var(--accent-light)" : "transparent",
                border: entry.isCurrentUser && !studentOverride ? "1px solid var(--accent-muted)" : "1px solid transparent",
              }}
            >
              ...
              <div style={{
                ...
                background: entry.isCurrentUser && !studentOverride
                  ? "linear-gradient(135deg, #6366F1, #8B5CF6)"
                  : "var(--bg-tertiary)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: "0.65rem", fontWeight: 700,
                color: entry.isCurrentUser && !studentOverride ? "white" : "var(--muted)",
                flexShrink: 0,
              }}>{entry.avatar}</div>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <p style={{
                  ...
                  color: entry.isCurrentUser && !studentOverride ? "var(--accent-dark)" : "var(--primary)",
                  whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
                }}>
                  {entry.name}
                  {entry.isCurrentUser && !studentOverride && (
                    <span style={{
